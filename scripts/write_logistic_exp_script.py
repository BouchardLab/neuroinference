...
def main(args):
    ...
    batch_script = (
        ...
        f"#SBATCH -q {qos}\n"
        "#SBATCH -J nb\n"
        "#SBATCH --output=/global/homes/s/sachdeva/out/neuroinference/coupling/logistic.o\n"
        "#SBATCH --error=/global/homes/s/sachdeva/error/neuroinference/coupling/logistic.o\n"
